...
const ProposalModal = (props: any) => {
  ...
  const setGithub = () => {
    console.log("Git", props.githubLink);
    if (
      props.githubLink.indexOf("http://") == 0 ||
      props.githubLink.indexOf("https://") == 0
    ) {
      console.log("Git true");
      return props.githubLink;
    } else {
      return `http://${props.githubLink}`;
    }
  };

  useEffect(() => {
    console.log("In admin modal 3");
    console.log(props);
  });
        ...
        >
          <div className={style.modalContent}>
            ...
            {/* <form
              ...
              noValidate
              autoComplete="off"
              // onClick={ ()=>{return window.location.href = `${props.githubLink}`}}
              onClick={() => {
                return window.open(`https://${props.githubLink}`, "_blank");
              }}
            >
              <TextField
